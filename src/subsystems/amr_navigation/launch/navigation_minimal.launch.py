...
Sequence:
  ...
  T2: ros2 launch amr_navigation amr_slam.launch.py       ← mapping (opsional, kalau mau SLAM live)
...
def generate_launch_description():
    ...
    # Pastikan nama file persis dengan yang ada di amr_navigation/config
